  ...
  return (
    <div className={styles['container']}>
      <div className={styles['container01']}>
        ...
        <div className={styles['container08']}>
          <div className={styles['container09']}>
            <span
              className={` ${styles['text01']} ${projectStyles['textXS']} `}
            >
              MAPA DO SITE
            </span>
            <span
              className={` ${styles['text02']} ${projectStyles['textSM']} `}
            >
              Sobre
            </span>
            <span
              className={` ${styles['text03']} ${projectStyles['textSM']} `}
            >
              Blog
            </span>
            <span
          ...
          <div className={styles['container10']}>
            <span
              className={` ${styles['text06']} ${projectStyles['textXS']} `}
            >
              OTHER RESOURCES
            </span>
            <span
            ...
            <span
              className={` ${styles['text08']} ${projectStyles['textSM']} `}
            >
              Terms &amp; Conditions
            </span>
            <span
      ...
      <a
        ...
        className={` ${styles['link']} ${projectStyles['textSM']} `}
      >
        Desenvolvido por &lt;/&gt; GuaráSoft
      </a>
    </div>
  )
}
